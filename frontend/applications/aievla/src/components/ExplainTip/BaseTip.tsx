...
const BaseTip = (props: BaseTipProps) => {
  ...
  return (
    <Tooltip {...tipProps} overlayClassName={classNames('c-explain-tip', overlayClassName, { 'auto-max': autoMaxWidth })}>
      {isDef(children) ? children : <QuestionCircleFilled className={classNames('c-question-icon ad-c-watermark ad-pointer', iconClassName)} />}
    </Tooltip>
  );
};
