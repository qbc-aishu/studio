...
describe("formatHeaders", () => {
    it("Parameters are null, null", function () {
    ...
    it("Parameters are null, undefined", () => {
...
describe("httpsRequest", () => {
    it('httpsRequest resolved with parameters {}, {data: "a"}', async () => {
...
//     it('Parameter is ${process.cwd()}/folder', () => {
